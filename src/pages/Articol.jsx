          ...
          <div className="row">
            <div className="col-md-10 col-lg-3 offset-md-1">
              <div className="toc">
                ...
                <ul>
                  <li>
                    <a href="#">Aliquam In Arcu </a>{" "}
                  </li>
                  <li>
                    <a href="#">Ut vehicula rhoncus</a>
                  </li>
                  <li>
            ...
            <div className="col-md-10 col-lg-7 offset-md-1 offset-lg-0">
              <div className="text">
                <p>
                  ...
                  <span style={{ textDecoration: "underline" }}>Vivamus</span>{" "}
                  ac sem lac. Ut vehicula rhoncus elementum. Etiam quis
                  tristique lectus. Aliquam in arcu eget velit pulvinar dictum
                  vel in justo. Vestibulum ante ipsum primis in faucibus orci
                  luctus et ultrices posuere cubilia Curae.
                </p>
                <p>
                  Praesent sed lobortis mi. Suspendisse vel placerat ligula.
                  Vivamus ac lacus. <strong>Ut vehicula rhoncus</strong>{" "}
                  elementum. Etiam quis tristique lectus. Aliquam in arcu eget
                  velit <em>pulvinar dict</em> vel in justo. Vestibulum ante
